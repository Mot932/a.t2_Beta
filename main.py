...
window = tk.Tk()
label = tk.Label(window, text="Анализатор текста 0.5 Beta", font=("Impact", 19), background="#c7730c")
label1 = tk.Label(window, text="Кол-во слов для вордклауд:", font=("Impact", 16), background="#F4A460")
